  ...
  return (
    <section className="flex items-center justify-center w-full h-screen bg-black">
      <div className="w-full px-5 mx-auto lg:container xl:max-w-screen-xl ">
        <div className="max-w-[540px] shadow-2xl mx-auto w-full border-2 border-gray-700  rounded px-5 md:px-10 py-5 md:py-10 lg:py-14  ">
          ...
          <form className="mt-5">
            ...
            <Button
              ...
              classes="w-full common-btn blue mt-6 text-base md:text-lg h-11"
              icon={<MessageCircleMore size={25} className="mr-3" />}
            />
            <Button
              text="Send OTP to WhatsApp"
              classes="w-full border border-green-500 hover:bg-green-500 group hover:text-white duration-300 ease-in-out  text-green-500 rounded flex items-center justify-center   mt-6 text-base md:text-lg h-11"
              icon={
                <FaWhatsapp
                  size={25}
